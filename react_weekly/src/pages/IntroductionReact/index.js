...
import matthewhamilton from './assets/img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg';
    ...
    <header>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="alterra">
                        <a href="index.html"><img class="logo-atas" src={logo}/></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="row align-items-center navig">
                            <div class="col-lg-3 col-md-3 col-sm-3 text-md-center text-sm-center text-lg-right"><a href="/introduction-react-index" class="aktif">HOME</a></div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 text-md-center text-sm-center text-lg-right"><a href="/contact-us">CONTACT</a></div> 
                        </div>
                </div>    
            </div>
        </div> 
        ...
        <div class="container h-100">
            <div class="row align-items-center isi-home">
                <div class="col-lg-4 col-md-12 col-sm-12  col-12">
                    <img id="foto-profil" src={matthewhamilton}/>
                </div>
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="main-p">
